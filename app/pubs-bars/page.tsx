  ...
  return <>
    ...
    <main id="main-content">
      ...
      <section className="pub-hero page-top">
        ...
        <div className="pub-hero-copy"><p className="eyebrow light">Pub marketing agency UK</p><h1>Make quieter nights <em>worth leaving home for.</em></h1><p>We help pubs and bars bring more people in for food, drinks, live sport, events and private hire. We use Google, social media, ads and customer follow-up depending on which night or offer needs help.</p><Link className="button button-cream" href="/start?type=pub-bar">Talk about my quiet night <span>↗</span></Link></div>
      </section>
      ...
      <section className="pub-final"><p>LAST ORDERS FOR QUIET NIGHTS</p><h2>Which night needs<br/><em>more people in the room?</em></h2><Link className="button button-cream" href="/start?type=pub-bar">Find my starting point <span>↗</span></Link></section>
    </main>
  </>;
}
