...
const plans = [
  {
    ...
    cta: "Start with Starter", href: "#contact"
  },
  {
    ...
    cta: "Build my visibility", href: "#contact"
  },
  {
    ...
    note: "Advertising spend is separate.", cta: "Build my demand", href: "#contact"
  },
  {
    ...
    note: "Advertising spend and third-party platform costs are separate.", cta: "Build my growth system", href: "#contact"
  }
];
    ...
    <main id="main-content">
      ...
      <section className="plan-selector section-pad">
        ...
        <div className="selector-list">
          <a href="#contact"><span>“Our social media keeps going quiet.”</span><b>Starter · £165</b><i>↗</i></a>
          <a href="#contact"><span>“Local people are not finding us enough.”</span><b>Visibility · £295</b><i>↗</i></a>
          <a href="#contact"><span>“We get attention, but not enough bookings.”</span><b>Demand · £495</b><i>↗</i></a>
          <a href="#contact"><span>“We need someone to handle the whole marketing picture.”</span><b>Full House · £1,000</b><i>↗</i></a>
        </div>
      </section>
      ...
      <section className="content-production section-pad" id="content-team">
        ...
        <div className="custom-quote"><p>Price depends on location, crew size, how often we shoot and how much content you need.</p><a href="#contact" className="button button-cream">Get a custom content quote <span>↗</span></a></div>
      </section>
