    ...
    <main id="main-content">
      <section className="credits-page page-top section-pad">
        <div className="credits-intro">
          <p className="eyebrow">Photography credits</p>
          <h1>Real photographs.<br /><em>Proper sources.</em></h1>
          <p>No Quiet Nights uses stock photography from Pexels and Unsplash. Source links are kept here so the image origins remain clear.</p>
        </div>
        ...
        <div className="license-note">
          <p>Licensing</p>
          <span>Pexels and Unsplash permit commercial website use under their respective licences. Always check current licence terms before reusing an image elsewhere.</span>
